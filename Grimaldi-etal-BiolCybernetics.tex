...
% https://github.com/SpikeAI/pyTERtorch/ (for developpment code)
%
% private
% https://framateam.org/spikeai/channels/fast-motion-biolcyb
% https://www.overleaf.com/project/630f9044c38e7a3cea81a7b2 (OBSOLETE)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Guest Editors:
...
\artnote{This article is published as part of the \textit{Biol Cyb} Special Issue on "What can Computer Vision learn from Visual Neuroscience?", see
...
%
%
\subsection{Accuracy versus efficiency tradeoff}% for the motion detection task}
%%%-----------------------------------------------------------------
%
%%%-----------------------------------------------------------------
%: fig:accuracy
