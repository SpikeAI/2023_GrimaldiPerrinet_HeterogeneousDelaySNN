...
\begin{figure}%[t!]
    ...
    \includegraphics[width=0.490\linewidth]{figures/THC_1a.pdf}
	    ...
	    {\bf (b)}~We show these motifs, each identified at the top by a different color. Each neurons and $71$ different possible delays is assigned the evidence of activation (red) or deactivation (blue). %The generative model is defined as a set of motifs (here $4$ PGs) each defined by a set of different synapses defined by weights (increasing with the radius of the black dots) at each different delay. 
...
\todo{try also a quantization of the weights (binary?)}
%
\section{Discussion}
%%%-----------------------------------------------------------------
%%%-----------------------------------------------------------------
