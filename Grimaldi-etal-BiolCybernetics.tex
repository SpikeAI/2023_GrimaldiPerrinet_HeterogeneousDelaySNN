...
\begin{figure}[t!]
    ...
    \includegraphics[width=0.490\linewidth]{figures/figure_1a.pdf}
	    ...
	    Note that each afferent may be connected with multiple weights at different delays. The propagation of the afferent information through these delay may generate at each time step a synchronous pattern on a subset of synapses. %These PG patterns were efficiently learned by a logistic regression.
