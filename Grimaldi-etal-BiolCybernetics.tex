...
In a review paper, we report experimental evidence for the presence of precise spiking motifs embedded in recordings from biological neural tissues~\cite{grimaldi_precise_2022}. These spatiotemporal patterns of neural activity can be an interesting representation used by neurons to perform cognitive tasks. 
