...
Taking the argument the other way around, one may deduce a generative model for generic raster plots. Indeed, any spike  in the presynaptic address space is generated by sensory neurons (for instance in the retina) or by afferent neurons. These are connected to the spiking cell by a set of weights and delays, and by assuming that these connections are sparsely distributes, one may deduce that this firing was caused by a specific temporal motif. , this will generate the propagation in 
