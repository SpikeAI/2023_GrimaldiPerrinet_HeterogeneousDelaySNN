...
%%%-----------------------------------------------------------------
%
Having defined our task, we may extend the convolution-based detection model to a 3D convolution 
such that the representation would also benefit from spatial invariance. The use of spatiotemporal filters on a stream of events was shown to improve CNN performances for an action recognition task in~\cite{ghosh2022conv3D} and we will here use a similar strategy, yet with a focus on using an event-based representation.
