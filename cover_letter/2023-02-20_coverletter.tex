...
\end{quote} 
 ...
 \noteRev{We improved the mathematical formulation of the model in sections 2.2.1 and 2.2.2 and hope that it clarifies the general framework we use. Regarding training, it is described more clearly in P9, L313. Demonstration of the mechanism and the analogy with Hebbian learning was done in~\cite{grimaldi_robust_2022} and was not reproduced here. We hope this new version offers a clearer methodology.}
...
\begin{quote}
 {\it Key results: Please summarize what you consider to be the outstanding features of the work.}
 Using a single layer of spiking neurons with heterogeneous delays to learn spatio-temporal  spiking motifs
\end{quote} 
\noteRev{We would like to thank reviewer \#2 for his comments. We have thoroughly revised the manuscript to take them into account.}
...
\noteRev{In fact, there was no mention of this previous work in the original manuscript, as this 4-page paper had not yet been published in the proceedings of the conference at which it had been presented. As mentioned in the responses to reviewer \#1 in this cover letter, we have now added this citation~\cite{grimaldi_learning_2022}. In addition, in this submitted manuscript we describe the main differences from that previous study: the use of a more ecological task (Section 2.1), a complete formulation of the model (Section 2.2), and the improvements made in this particular model (P8, L285). We also provide citations to studies using similar methods (P8, L259). Further results are presented, especially the testing of the learned model with parametric textures.}
