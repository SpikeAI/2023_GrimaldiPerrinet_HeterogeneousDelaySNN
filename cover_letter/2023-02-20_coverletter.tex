...
\end{quote} 
\noteRev{We thank Reviewer 2 for its comments. We have thoroughly reworked the manuscript to take them into account.}
...
\noteRev{Indeed this previous work was not mentioned in the original manuscript as this 4-pages paper was not yet published in the proceedings of the conference in which it was presented. As mentioned in this cover letter and in the previous responses to reviewer \#1, we now added this citation~\cite{grimaldi_2022} and describe the main differences with the submitted study: the use of a more ecological task (section 2.1), a complete formulation of the model (section 2.2) and the ameliroations provided in this particular model (P8, L269). We also cite studies that use similar methods (P7, L243). We also cover more extensive results, notably by testing the learned model with parameterized textures. }
