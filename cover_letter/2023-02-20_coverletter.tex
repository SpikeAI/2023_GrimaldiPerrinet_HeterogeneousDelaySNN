...
\noteRev{In fact, there was no mention of this previous work in the original manuscript, as this 4-page paper had not yet been published in the proceedings of the conference at which it had been presented. As mentioned in the responses to reviewer \#1 in this cover letter, we have now added this citation~\cite{grimaldi_learning_2022}. In addition, in this submitted manuscript we describe the main differences from that previous study: the use of a more ecological task (Section 2.1), a complete formulation of the model (Section 2.2), and the improvements made in this particular model (P8, L269). We also provide citations to studies using similar methods (P7, L243). Further results are presented, especially the testing of the learned model with parametric textures.}
