...
We thank the reviewer for the positive assessment, which encouraged us to further improve our manuscript. As a result, this revision is a major overhaul of the manuscript that follows the reviewers' comments. In particular, we have extended the results to natural scenes, which gives the paper a broader impact. Given the substantial changes we have made to the original manuscript to reduce and clarify the various sections, we do not provide a tracked changes version of the revision (such a document can be provided if needed). Below we provide a point-by-point response to the reviewers with references to the manuscript.
